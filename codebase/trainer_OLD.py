...
from codebase.model import G_DCGAN, G_NET, RNNEncoder, CNN_ENCODER
from codebase.model import D_NET64, D_NET128, D_NET256
...
class condGANTrainer(object):
    ...
    def build_models(self):
        ...
        text_encoder = RNNEncoder(self.n_words, nhidden=cfg.TEXT.EMBEDDING_DIM, nlayers=cfg.TEXT.RNN_LAYERS)
        ...
        for i in range(len(netsD)):
            ...
            # print(netsD[i])
        print('Number of nets G/D: {}'.format(len(netsD)))
