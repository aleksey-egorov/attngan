...
def drawCaption(convas, captions, ixtoword, vis_size, off1=2, off2=2):
    ...
    fnt = ImageFont.truetype('resource/fonts/FreeMono.ttf', 20)
...
def build_super_images(real_imgs, captions, ixtoword,
    ...
    real_imgs = F.interpolate(input=real_imgs, size=(vis_size, vis_size), mode='bilinear', align_corners=True) # prev nn.Upsample
    # [-1, 1] --> [0, 1]
    ...
    if lr_imgs is not None:
        lr_imgs = F.interpolate(input=lr_imgs, size=(vis_size, vis_size), mode='bilinear', align_corners=True) # prev nn.Upsample
        # [-1, 1] --> [0, 1]
